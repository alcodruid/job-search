...
**Проект 2:**
```
[PROD] TelecomExpert.ru — Маркетплейс для операторов связи
Маркетплейс нормативных документов, шаблонов и методических материалов для малых операторов
связи РФ. RAG-поиск: задай вопрос — получи ответ с цитатой из документации.
Открыт для операторов: telecomexpert.ru
